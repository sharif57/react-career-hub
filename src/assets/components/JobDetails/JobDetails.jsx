...
const JobDetails = () => {
    ...
    return (
        <div>
            <h2 className="mb-8 text-center text-5xl font-bold mt-11">job details {id}</h2>
            <div className="grid gap-4 md:grid-cols-4">
                <div className="border md:col-span-3 space-y-6">
                    ...
                    <p> <span className="text-2xl font-bold">Job Responsibility:</span> Collaborating with cross-functional teams: UI/UX designers often work closely with other teams, including product management, engineering, and marketing, to ensure that the user interface is aligned with business and technical requirements. You will need to be able to effectively communicate your design ideas and gather feedback from other team members.</p>
                ...
                <div className="border">
                    <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8 bg-gray-500 text-gray-100">
                        ...
                        <form novalidate="" action="" className="space-y-8">
                            ...
                            <button onClick={handleApplyJob} type="button" className="w-full px-8 py-3 font-semibold rounded-md bg-violet-400 text-gray-900">Apply Now</button>
                        </form>
                    </div>
                </div>
            </div>
